...
func Initialize() {
	...
	content.SetTypeReaderRegistry(bootstrap.typeReaderRegistry)
	core.SetContentReaderRegistry(bootstrap.contentReaderRegistry)
	content.SetContentFactory(bootstrap.contentFactory)
