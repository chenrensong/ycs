...
type IStructStore interface {
	...
	ReadAndApplyDeleteSet(decoder IDSDecoder, transaction ITransaction)
	ReplaceStruct(oldStruct IStructItem, newStruct IStructItem)
