...
namespace Ycs
{
    ...
    public class YTextTests : YTestBase
    {
        ...
        public void TestBasicFormat()
        {
            ...
            Assert.AreEqual("b", ((((text0.Start.Right as IStructItem)?.Right as IStructItem)?.Right as IStructItem)?.Content as ContentString)?.GetString());
